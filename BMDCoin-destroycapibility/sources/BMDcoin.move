module BMDCOIN2::bmd_coin {
    ...
    fun init_module(
        ...
        let (burn_cap, freeze_cap, mint_cap) = coin::initialize<BMDCOIN2>(
            account,
        ...
        move_to(account, Capabilities<BMDCOIN2> {
            mint_cap,
        });
        ...
        public entry fun destroy_mint_cap(account: &signer) acquires Capabilities {
        let account_addr = signer::address_of(account);
        let Capabilities { mint_cap } = move_from<Capabilities<BMDCOIN2>>(account_addr);
